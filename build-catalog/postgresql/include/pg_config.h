...
#define CONFIGURE_ARGS " '--prefix=/u/z/z/zzheng/Research/catalog-query/build-catalog/postgresql'"
...
#define PG_VERSION_STR "PostgreSQL 16.3 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0, 64-bit"
