...
if __name__ == "__main__":
    ...
    db_manager = PostgresManager(postgreq_params, neo4j_params, taxonomy_json_path = ["../config/schema/node_type_taxonomy.json","../config/schema/edge_type_taxonomy.json"])
